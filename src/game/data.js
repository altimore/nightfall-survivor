...
export const SKILLS = {
  ...
  floating:  { name:"Lames Suspendues",   icon:"🗡️", color:"#bcd0ff", type:"weapon",  max:5, desc:["2 lames flottent autour · se lancent sur les ennemis proches","3 lames maximum","4 lames · dégâts +30%","5 lames · génération plus rapide","6 lames · dégâts +50% · explosion à l'impact"] },
  ...
  flamethrower:{ name:"Lance-Flammes",    icon:"🔥", color:"#ff6633", type:"weapon",  max:5, desc:["Cône de feu continu (60°, 150 px)","Cône 80°","Portée 180 px · dégâts +50%","Cône 100° · dégâts +30%","Double cône avant/arrière"] },
